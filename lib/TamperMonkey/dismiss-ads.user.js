...
(function () {
    ...
    var classesControllingAdvertisements = [
        "adblock-close",
        "adblock-img-wrapper"
    ];
    ...
    function isBannerLoaded() {
        function hideAdDivs() {
            ...
            var adDivs = document.querySelectorAll('div.dcr-lomca2');
            adImages.forEach(function (div) {
                div.style.display = 'none';
                message("hiding ad for div" + div);
            });
        }
        function checkElements(elements) {
            ...
            var _loop_1 = function (element) {
                ...
                classesControllingAdvertisements.forEach(function (className) {
                    if (element.classList.contains(className)) {
                        message('returning element ' + element + ' for class ' + className);
            ...
            // Loop through the elements and check the class, aria-label and label attributes as well as the textContent
