...
// @match	 https://www.thebloodconnection.org/donate-blood/donor-forms/tbc-express-pass
...
(function () {
    ...
    function clickButtons() {
        ...
        var autoAcceptIds = [
            "IunderstandthattheTBCExpressPassmustbecompletedonthesamedayasmydonation",
            "checkbox_2",
            "i_understand_the_educational_materials_view",
            "_i_understand_the_blood_donation_process_view",
            "_i_understand_the_post_donation_instructions_view",
        ];
                ...
                if (el) {
                    ...
                    if (el.innerHTML === value) {
                        ...
                        if (key === "btn-success") { // Only click for these URLs
                            ...
                            if (href === "https://xpress.donorhistory.com/8/question/330")
                                el.click();
                        }
                        else {
                            el.click();
        ...
        autoAcceptIds.forEach(function (id) {
