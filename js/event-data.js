const eventDataVersion = "Friday, 2026-06-26 10:55:05";
...
const events = [
    {
        ...
        start_time: "",
        end_time: "",
        name: `Failed to fetch events: HTTPSConnectionPool(host='millsriver.boldrock.com', port=443): Max retries exceeded with url: /taproomevents (Caused by NameResolutionError("HTTPSConnection(host='millsriver.boldrock.com', port=443): Failed to resolve 'millsriver.boldrock.com' ([Errno -3] Temporary failure in name resolution)"))`,
