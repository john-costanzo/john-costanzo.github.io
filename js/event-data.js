const eventDataVersion = "Sunday, 2026-06-07 14:18:10";
...
const events = [
    ...
    },
    {
        ...
        detail: "Down home roots with a modern edge. Lead vocalist/guitarist and songwriter, Dave Dribbon started the band in 2015. Kimberly Tzakos is also on lead vocals, adding beautiful tone, range and soul to the mix. The songs are Indie/Americana/Rock/Soul. Strong gritty vocals with rich harmonies and a dynamic but sometimes heavy backbeat. The songs are complimented by bassist Tyler Mack and Will Miller on drums. They are both backing vocalists and influence the music with Rock, Cajun and Americana rhythms. Josh Bertram is on lead guitar and adds Trey Anastasio motivated rockin’ solos with the tastefulness of Mike Campbell style riffs. Zach Knox adds depth, color and emotion to the band through his keys playing and improvisation. Zach is also a talented vocalist, bringing backing and lead vocals to the mix. Wrapped in southern roots, there’s a nostalgic vibe in the songwriting and an Indie feel in the sound. Imagine if Blind Melon, Bonnie Raitt and Van Morrison made an album! This is the soul of Sidecar Honey. \n— thoughtful Americana with pop hooks and rock propulsion, they manage to feel at once fresh and familiar.",
        location: "Sierra Nevada 100 Sierra Nevada Way Mills River, NC 28732",
    },
    {
        url: "https://visithendersonvillenc.org/summer-concerts",
