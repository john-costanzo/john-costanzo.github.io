const eventDataVersion = "Thursday, 2026-03-26 14:04:11";
...
const events = [
    {
        ...
        start_time: "",
        end_time: "",
        name: `Failed to fetch events: HTTPSConnectionPool(host='www.saintpaulfarms.com', port=443): Max retries exceeded with url: /cidery-events (Caused by NewConnectionError('<urllib3.connection.HTTPSConnection object at 0x7f6c8a5f0750>: Failed to establish a new connection: [Errno -3] Temporary failure in name resolution'))`,
