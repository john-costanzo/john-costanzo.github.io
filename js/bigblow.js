/* Copied from https://web.archive.org/web/20200317094658/https://fniessen.github.io/org-html-themes/styles/bigblow/js/bigblow.js on 2020-12-06 */
    ...
    $(document).on('mouseenter', '.org-src-container', function () {
        ...
        if ((window.location.protocol != 'file:') && ($(this).find('.zclip').length == 0)) {
            $(this).find('.copy-to-clipboard-button').zclip({
                //path: 'https://web.archive.org/web/20200317094658/http://www.steamdev.com/zclip/js/ZeroClipboard.swf',
...
/*
     FILE ARCHIVED ON 09:46:58 Mar 17, 2020 AND RETRIEVED FROM THE
     INTERNET ARCHIVE ON 13:26:02 Dec 06, 2020.
...
/*
playback timings (ms):
  PetaboxLoader3.resolve: 44.596
  esindex: 0.018
  captures_list: 133.859
  RedisCDXSource: 55.911
  LoadShardBlock: 52.984 (3)
  PetaboxLoader3.datanode: 54.85 (4)
  exclusion.robots.policy: 0.226
  load_resource: 49.219
  CDXLines.iter: 20.876 (3)
