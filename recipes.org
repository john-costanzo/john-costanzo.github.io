...
#+HTML_HEAD: <style>
#+HTML_HEAD:     :target {
#+HTML_HEAD:         border: 2px solid #D4D4D4;
#+HTML_HEAD:         background-color: #e5eecc;
#+HTML_HEAD:     }
#+HTML_HEAD:     .separator {
#+HTML_HEAD:         margin-bottom: 750px;
#+HTML_HEAD:         border-top: 5px solid #D4D4D4;
#+HTML_HEAD:     }
#+HTML_HEAD: </style>
#+HTML_HEAD: #+TITLE: The Costanzos's Favorite Recipes
#+SETUPFILE: https://fniessen.github.io/org-html-themes/setup/theme-readtheorg.setup
#+STARTUP: showeverything
#+OPTIONS: toc:2
* Beverages
:PROPERTIES:
:CUSTOM_ID: CostanzoRecipes_Beverages
:END:

** Chai Tea
:PROPERTIES:
:CUSTOM_ID: CostanzoRecipes_Beverages_ChaiTea
:END:
*** Ingredients
...
** Hot Cocoa
:PROPERTIES:
:CUSTOM_ID: CostanzoRecipes_Beverages_HotCocoa
:END:
*** Method (for a 12 oz serving):
- Boil 8 oz boiling water
- 4 TBS (1/4 cup) Powdered Whole milk 
- 2 (or up to 3) TBS cane sugar (or brown, which I like a lot)
- Add 3 TBS Full fat cocoa
- Stir like mad! If it ain’t mixed now, too late.
- Now, the balance is up to you, I add 4 oz 1/2 and 1/2
...
** Mojitos
:PROPERTIES:
:CUSTOM_ID: CostanzoRecipes_Beverages_Mojitos
:END:
...
** Sangria
:PROPERTIES:
:CUSTOM_ID: CostanzoRecipes_Beverages_Sangria
:END:
...
* Bread
:PROPERTIES:
:CUSTOM_ID: CostanzoRecipes_Bread
:END:

** Amazing Rosemary Bread
:PROPERTIES:
:CUSTOM_ID: CostanzoRecipes_Bread_AmazingRosemaryBread
:END:
*** Ingredients
- 1 tablespoon yeast
- 1 tablespoon sugar
...
** Cheesy Herb Rolls
:PROPERTIES:
:CUSTOM_ID: CostanzoRecipes_Bread_CheesyHerbRolls
:END:
*** Ingredients
...
:PROPERTIES:
:CUSTOM_ID: CostanzoRecipes_Bread_CheesyHerbRollsDoubleBatch
:END:
*** Ingredients
...
:PROPERTIES:
:CUSTOM_ID: CostanzoRecipes_Bread_ChewySourdoughItalianBread
:END:
*** Ingredients
...
:PROPERTIES:
:CUSTOM_ID: CostanzoRecipes_Bread_CinnabonsUsingBreadMachine
:END:
*** Ingredients
...
:PROPERTIES:
:CUSTOM_ID: CostanzoRecipes_Bread_CracklingCornbreadFromSilverPalate
:END:
...
:PROPERTIES:
:CUSTOM_ID: CostanzoRecipes_Bread_CrustyHomemadeBread
:END:
*** Ingredients
...
** Custardy Popovers
:PROPERTIES:
:CUSTOM_ID: CostanzoRecipes_Bread_CustardyPopovers
:END:
*** Ingredients
- 4 eggs
- 1 cup milk
...
** Hot Cross Buns
:PROPERTIES:
:CUSTOM_ID: CostanzoRecipes_Bread_HotCrossBuns
:END:
*** Times
...
** Irish Soda Bread
:PROPERTIES:
:CUSTOM_ID: CostanzoRecipes_Bread_IrishSodaBread
:END:
...
:PROPERTIES:
:CUSTOM_ID: CostanzoRecipes_Bread_JapaneseMilkBreadRolls
:END:
*** Ingredients
**** TANGZHONG (starter)
- 43g (3T) water
...
:PROPERTIES:
:CUSTOM_ID: CostanzoRecipes_Bread_LemonPoppySeedMuffinsAndOrQuickBreadLoaf
:END:
...
** Naan
:PROPERTIES:
:CUSTOM_ID: CostanzoRecipes_Bread_Naan
:END:
...
2. Knead with your hands for about 1-2 minutes. The dough will be very sticky, if it feels soupy, add a bit more flour until it's sticky but not runny. Otherwise, you can wet your hands to prevent the dough from sticking too much. Shape the dough into a rough ball and turn seam-side down. Cover the bowl and place it in a warm spot, like a cold oven with the light turned on. Let the dough rise 30-40 minutes until swollen 1 1/2 - 2x in size. Alternatively, you can put the dough in the refrigerator for 2-24 hours to rise.
3. Turn the dough out onto a clean and flour dusted counter. Divide the dough into equal 4 pieces and shape into balls, dusting with flour as needed to prevent sticking. Set the dough balls on a floured plate, and sprinkle more flour on top. Cover with a lint free towel and let rise while the oven preheats.
4. Preheat the oven to 550 ºF, or as hot as your oven goes with a rack positioned 1/3 from the top of the oven. If you have one, place a baking steel or baking stone on that rack to preheat. Let the oven preheat for at least 45 minutes to saturate the sides and baking steel or stone (if using) with heat.
5. After the second rise, roll the dough with a rolling pin to shape it into a teardrop shape--roll into a rough circle, then roll one part of the circle or stretch it to make a more triangular shape. Brush the top with melted butter (or coconut oil) and sprinkle on minced garlic if making garlic naan.
6. Prepare 2 naan and then carefully transfer them to the hot oven. If you'd like you can place the shaped bread onto parchment paper, and slide the whole thing onto the baking steel with a pizza peel or a baking tray (use the backside if rimmed). If not using a baking steel or baking stone, place the dough on a parchment lined baking tray to place directly in the oven.
7. Bake for 3-5 minutes until there are some golden spots on the bubbled surface. If desired, turn on the broiler for 1-2 minutes after 3-4 minutes of baking.
8. Repeat with remaining dough. For restaurant style presentation, brush the hot dough with some more vegan butter, the butter will melt on contact. If desired, sprinkle with cilantro to serve.
*** Yield 
4 large naan
*** Credits
- From https://www.thecuriouschickpea.com/vegan-homemade-restaurant-style-naan/
- date created: [2020-03-29 Sun]

#+BEGIN_separator
#+END_separator
** No-knead Crusty Bread
:PROPERTIES:
:CUSTOM_ID: CostanzoRecipes_Bread_NoKneadCrustyBread
:END:
*** Ingredients
...
:PROPERTIES:
:CUSTOM_ID: CostanzoRecipes_Bread_NotesOnSourdoughStarter
:END:
...
** Pain au Levain
:PROPERTIES:
:CUSTOM_ID: CostanzoRecipes_Bread_PainAuLevain
:END:
Makes 2 loaves
...
** Pain de Campagne
:PROPERTIES:
:CUSTOM_ID: CostanzoRecipes_Bread_PainDeCampagne
:END:
*** Ingredients
**** Levain
...
** Pane Pugliese
:PROPERTIES:
:CUSTOM_ID: CostanzoRecipes_Bread_PanePugliese
:END:
Makes 2 loaves
*** Ingredients
**** Biga
...
** Pita Bread
:PROPERTIES:
:CUSTOM_ID: CostanzoRecipes_Bread_PitaBread
:END:
About 2 hours
*** Ingredients
...
** Pumpkin Bread
:PROPERTIES:
:CUSTOM_ID: CostanzoRecipes_Bread_PumpkinBread
:END:
...
** Rustic Bread
:PROPERTIES:
:CUSTOM_ID: CostanzoRecipes_Bread_RusticBread
:END:
...
:PROPERTIES:
:CUSTOM_ID: CostanzoRecipes_Bread_SourdoughBreadNewYorkTimes
:END:
*** Ingredients
...
*** Credits
- From How to Make Sourdough Bread, /A Guide By Claire Saffitz https://cooking.nytimes.com/guides/59-how-to-make-sourdough-bread/
- date created: [2020-04-19 Sun]
- [2020-04-19 Sun] Made two beautiful loaves (gave one to Nancy). Since I didn't use rice flour, had to scrape the dough off the towels before placing into Dutch oven. Also, I screwed up on the second loaf: I didn't cover the Dutch oven until the middle (instead of first) 20 minutes. It didn't rise as much as the first, but wasn't too bad.
- [2020-05-03 Sun] Made a half recipe (one loaf). Tried to optimize the stickiness by doing the final rise not over a towel but (lightly floured) parchment instead. The paper sort of worked, but was a bit of a hassle to pick out of the cooked bread, since the bread rose around it. The big problem I had is that I forgot to lower the temperature after I removed the Dutch oven top. The bread cooked quicker and was a quite a bit darker than it ought to be.

#+BEGIN_separator
#+END_separator
** Sourdough English Muffins (King Arthur)
:PROPERTIES:
:CUSTOM_ID: CostanzoRecipes_Bread_SourdoughEnglishMuffinsKingArthur
:END:
*** Ingredients
...
** Sourdough Pretzels
:PROPERTIES:
:CUSTOM_ID: CostanzoRecipes_Bread_SourdoughPretzels
:END:
*** Ingredients
**** Pretzels
- 3/4 cup (170g) water
...
:PROPERTIES:
:CUSTOM_ID: CostanzoRecipes_Bread_SourdoughRyeBreadWithBeer
:END:
Makes 1 large loaf
*** Ingredients
...
7. Let the bread rise a second time until doubled, about 1 1/2 - 2 hours. When the bread is ready to bake, it will hold an indentation of your finger when you press it lightly, rather than springing back.
...
:PROPERTIES:
:CUSTOM_ID: CostanzoRecipes_Bread_SourdoughSpeltRyeBread
:END:
*** Ingredients
...
:PROPERTIES:
:CUSTOM_ID: CostanzoRecipes_Bread_TexasStyleCornbread
:END:
...
** Tortillas
:PROPERTIES:
:CUSTOM_ID: CostanzoRecipes_Bread_Tortillas
:END:
*** Ingredients
- 1 cup flour
- 1/4 tsp salt
...
* Breakfast
:PROPERTIES:
:CUSTOM_ID: CostanzoRecipes_Breakfast
:END:

** Apple Fritters
:PROPERTIES:
:CUSTOM_ID: CostanzoRecipes_Breakfast_AppleFritters
:END:
*** Ingredients
**** Fritters
...
2. Make a well in the center and add 2/3 cup milk, eggs and applesauce. (Consider mixing liquids together first.)
...
5. Heat 1 1/2 inches of oil in heavy skillet, dutch oven or deep fryer to 375 degrees.
6. Drop about 1/4 cup of batter per fritter into hot oil; spreading it out as you drop.
7. Cook each side until golden brown; approximately 2 minutes per side.
8. Remove to paper towels to drain.
9. Whisk together 1/4 cup milk, powdered sugar and vanilla.
...
** Banana Muffins
:PROPERTIES:
:CUSTOM_ID: CostanzoRecipes_Breakfast_BananaMuffins
:END:
*** Ingredients
...
** Baron Bagels
:PROPERTIES:
:CUSTOM_ID: CostanzoRecipes_Breakfast_BaronBagels
:END:
*** Ingredients
...
** Belgian Waffles
:PROPERTIES:
:CUSTOM_ID: CostanzoRecipes_Breakfast_BelgianWaffles
:END:
*** Ingredients
*** Method
...
** Best Bran Muffins
:PROPERTIES:
:CUSTOM_ID: CostanzoRecipes_Breakfast_BestBranMuffins
:END:
*** Ingredients
...
:PROPERTIES:
:CUSTOM_ID: CostanzoRecipes_Breakfast_BestButtermilkWaffles
:END:
*** Ingredients
- 2 1/2 c. flour
- 1/2 tsp. salt
...
:PROPERTIES:
:CUSTOM_ID: CostanzoRecipes_Breakfast_BlueberryButtermilkMuffins
:END:
*** Ingredients
- 1 cup buttermilk
...
:PROPERTIES:
:CUSTOM_ID: CostanzoRecipes_Breakfast_ButtermilkSconesWithRaisins
:END:
...
** Buttermilk Syrup
:PROPERTIES:
:CUSTOM_ID: CostanzoRecipes_Breakfast_ButtermilkSyrup
:END:
*** Ingredients
...
** Claridge’s Scones
:PROPERTIES:
:CUSTOM_ID: CostanzoRecipes_Breakfast_Claridge�SScones
:END:
*** Ingredients
...
** Cranberry Muffins
:PROPERTIES:
:CUSTOM_ID: CostanzoRecipes_Breakfast_CranberryMuffins
:END:
...
:PROPERTIES:
:CUSTOM_ID: CostanzoRecipes_Breakfast_CrepesWithVanillaCreamSauceBobEvans
:END:
*** Ingredients
**** For 3-4
***** Crepes
...
- 1/2 teaspoon vanilla extract
- 1/8 cup sour cream
- 1/4 cup heavy cream (a little thinner than pudding, add until it is thin enough to just drip)
**** For 6-8
***** Crepes
- 1 3/4 cups milk
- 3 whole eggs
...
5. Pour 1/4 cup of batter into the pan and tip pan to spread the batter evenly. When bubbles form on the top and the edges are dry, flip over and cook until lightly browned, it will have a lacy look.
...
:PROPERTIES:
:CUSTOM_ID: CostanzoRecipes_Breakfast_CrispyOvenRoastedBreakfastPotatoes
:END:
*** Ingredients
...
- [2020-01-19 Sun] Made for bunch with Mom, Lucille and John. Good, crispy. Used Penzy's Turkish spice.

#+BEGIN_separator
#+END_separator
** Fruit and Nut Muffins
:PROPERTIES:
:CUSTOM_ID: CostanzoRecipes_Breakfast_FruitAndNutMuffins
:END:
...
** German Pancakes
:PROPERTIES:
:CUSTOM_ID: CostanzoRecipes_Breakfast_GermanPancakes
:END:
*** Ingredients
- 1 tablespoon butter
- 1/2 cup milk
...
** Gingerbread Granola
:PROPERTIES:
:CUSTOM_ID: CostanzoRecipes_Breakfast_GingerbreadGranola
:END:
*** Ingredients
**** Dry
...
:PROPERTIES:
:CUSTOM_ID: CostanzoRecipes_Breakfast_GoldenRaisinOatBranMuffins
:END:
...
** Great Granola
:PROPERTIES:
:CUSTOM_ID: CostanzoRecipes_Breakfast_GreatGranola
:END:
*** Ingredients
- 1/4 cup butter
...
:PROPERTIES:
:CUSTOM_ID: CostanzoRecipes_Breakfast_LaurenGrovemanSBagels
:END:
*** Ingredients
...
:PROPERTIES:
:CUSTOM_ID: CostanzoRecipes_Breakfast_OatmealRaisinPancakesWithCinnamonSourCream
:END:
...
** Overnight Oats
:PROPERTIES:
:CUSTOM_ID: CostanzoRecipes_Breakfast_OvernightOats
:END:
*** Ingredients
...
** Pancakes, Buttermilk
:PROPERTIES:
:CUSTOM_ID: CostanzoRecipes_Breakfast_PancakesButtermilk
:END:
*** Ingredients
- 1 egg
- 1 cup buttermilk
...
** Pancakes, Sourdough
:PROPERTIES:
:CUSTOM_ID: CostanzoRecipes_Breakfast_PancakesSourdough
:END:
*** Ingredients
**** Single Recipe
***** Overnight Sponge
...
** Pumpkin Muffins
:PROPERTIES:
:CUSTOM_ID: CostanzoRecipes_Breakfast_PumpkinMuffins
:END:
*** Ingredients
...
:PROPERTIES:
:CUSTOM_ID: CostanzoRecipes_Breakfast_SaltedCaramelSauce
:END:
*** Ingredients
...
** Scones, Irish
:PROPERTIES:
:CUSTOM_ID: CostanzoRecipes_Breakfast_SconesIrish
:END:
*** Ingredients
- 2 1/2 cup flour
- 1/4 cup rolled oats
...
:PROPERTIES:
:CUSTOM_ID: CostanzoRecipes_Breakfast_StuffedFrenchToast
:END:
*** Ingredients
...
* Desserts
:PROPERTIES:
:CUSTOM_ID: CostanzoRecipes_Desserts
:END:

** Almond Horns
:PROPERTIES:
:CUSTOM_ID: CostanzoRecipes_Desserts_AlmondHorns
:END:
...
** Apple Crisp
:PROPERTIES:
:CUSTOM_ID: CostanzoRecipes_Desserts_AppleCrisp
:END:
*** Ingredients
**** Base
...
- date created: [2019-10-07 Mon]

#+BEGIN_separator
#+END_separator
** Apple Fritters 
:PROPERTIES:
:CUSTOM_ID: CostanzoRecipes_Desserts_AppleFritters
:END:
*** Ingredients
- Points: 4
- Servings: 4
...
** Apple Twist Bread
:PROPERTIES:
:CUSTOM_ID: CostanzoRecipes_Desserts_AppleTwistBread
:END:
*** Ingredients
**** Dough
...
:PROPERTIES:
:CUSTOM_ID: CostanzoRecipes_Desserts_AuntAnnaSAppleCake
:END:
*** Ingredients
...
** Banana Bread
:PROPERTIES:
:CUSTOM_ID: CostanzoRecipes_Desserts_BananaBread
:END:
*** Ingredients
- 1 cup all-purpose flour
- 1 cup whole wheat flour
...
** Biscotti
:PROPERTIES:
:CUSTOM_ID: CostanzoRecipes_Desserts_Biscotti
:END:
*** Ingredients
...
** Blueberry Cobbler
:PROPERTIES:
:CUSTOM_ID: CostanzoRecipes_Desserts_BlueberryCobbler
:END:
*** Ingredients
...
** Blueberry Hand Pies
:PROPERTIES:
:CUSTOM_ID: CostanzoRecipes_Desserts_BlueberryHandPies
:END:
*** Ingredients
...
:PROPERTIES:
:CUSTOM_ID: CostanzoRecipes_Desserts_BlueberryZucchiniSnackCakeWithLemonButtercream
:END:
...
** Bread Pudding
:PROPERTIES:
:CUSTOM_ID: CostanzoRecipes_Desserts_BreadPudding
:END:
*** Ingredients
- 2 eggs
- 2 cups hot milk
...
:PROPERTIES:
:CUSTOM_ID: CostanzoRecipes_Desserts_ChocolateCakePanCakeKingArthurFlourSOriginal
:END:
*** Ingredients
...
:PROPERTIES:
:CUSTOM_ID: CostanzoRecipes_Desserts_ChocolateChipCookies
:END:
*** Ingredients
...
** Chocolate Cream Pie
:PROPERTIES:
:CUSTOM_ID: CostanzoRecipes_Desserts_ChocolateCreamPie
:END:
*** Ingredients
**** Crust
...
:PROPERTIES:
:CUSTOM_ID: CostanzoRecipes_Desserts_ChocolateTruffleCookies
:END:
*** Ingredients
...
:PROPERTIES:
:CUSTOM_ID: CostanzoRecipes_Desserts_ChocolateZucchiniCake
:END:
*** Ingredients
...
:PROPERTIES:
:CUSTOM_ID: CostanzoRecipes_Desserts_ClassicPieCrustKingArthur
:END:
*** Ingredients
**** 2 Crusts
...
:PROPERTIES:
:CUSTOM_ID: CostanzoRecipes_Desserts_ClassicSinglePieDough
:END:
*** Ingredients
...
** Coconut Layer Cake
:PROPERTIES:
:CUSTOM_ID: CostanzoRecipes_Desserts_CoconutLayerCake
:END:
...
:PROPERTIES:
:CUSTOM_ID: CostanzoRecipes_Desserts_DoubleLemonPoppySeedBundtCake
:END:
Serves: 16
*** Ingredients
- 1/4 cup poppy seeds
...
:PROPERTIES:
:CUSTOM_ID: CostanzoRecipes_Desserts_East62NdStreetLemonCake
:END:
By Craig Claiborne
- TIME About 2 hours
...
** Flaky Pie Crust
:PROPERTIES:
:CUSTOM_ID: CostanzoRecipes_Desserts_FlakyPieCrust
:END:
...
** Ginger Snaps
:PROPERTIES:
:CUSTOM_ID: CostanzoRecipes_Desserts_GingerSnaps
:END:
*** Notes:
- 4-July-06:
...
:PROPERTIES:
:CUSTOM_ID: CostanzoRecipes_Desserts_LemonCornmealCakeWithLemonGlazeAndCrushedBlueberrySauce
:END:
*** Ingredients
...
:PROPERTIES:
:CUSTOM_ID: CostanzoRecipes_Desserts_PeachMelbaCreamCake
:END:
*** For the cake:
**** Ingredients
...
** Pie Crust (Classic)
:PROPERTIES:
:CUSTOM_ID: CostanzoRecipes_Desserts_PieCrustClassic
:END:
*** Ingredients
- 2 cups all-purpose flour
- 1 teaspoon salt
...
** Pumpkin Cookies
:PROPERTIES:
:CUSTOM_ID: CostanzoRecipes_Desserts_PumpkinCookies
:END:
*** Ingredients
- 1/2 cup (113g) butter
...
- 1 teaspoon nutmeg
- 1 teaspoon cinnamon
- 1/2 cup (140g) diced or slivered roasted almonds
...
** Ricotta Cookies
:PROPERTIES:
:CUSTOM_ID: CostanzoRecipes_Desserts_RicottaCookies
:END:
...
** Spoon Cookies
:PROPERTIES:
:CUSTOM_ID: CostanzoRecipes_Desserts_SpoonCookies
:END:
...
** Tiramisu
:PROPERTIES:
:CUSTOM_ID: CostanzoRecipes_Desserts_Tiramisu
:END:
*** Ingredients
- 3 eggs
- 1/2 cup sugar
...
* Entrees
:PROPERTIES:
:CUSTOM_ID: CostanzoRecipes_Entrees
:END:

** Asparagus Frittata with Basil, Shallots and Parmesan
:PROPERTIES:
:CUSTOM_ID: CostanzoRecipes_Entrees_AsparagusFrittataWithBasilShallotsAndParmesan
:END:
*** Ingredients
...
:PROPERTIES:
:CUSTOM_ID: CostanzoRecipes_Entrees_BlackBeanAndRiceEnchiladas
:END:
*** Ingredients
...
:PROPERTIES:
:CUSTOM_ID: CostanzoRecipes_Entrees_ButternutSquashSoup
:END:
*** Ingredients
...
:PROPERTIES:
:CUSTOM_ID: CostanzoRecipes_Entrees_CajunMeatLoafWithChiliSauce
:END:
*** Meat Loaf
**** Ingredients
...
** Corn Chowder
:PROPERTIES:
:CUSTOM_ID: CostanzoRecipes_Entrees_CornChowder
:END:
*** Ingredients
- 2 onions, chopped
- 3 potatoes, diced
...
** Corn Souffle
:PROPERTIES:
:CUSTOM_ID: CostanzoRecipes_Entrees_CornSouffle
:END:
*** Ingredients
- 2 eggs
...
:PROPERTIES:
:CUSTOM_ID: CostanzoRecipes_Entrees_CrispyRedPotatoesWithWarmAsianSlawLimeySauce
:END:
*** Overview
...
** Curried Lentil Dish
:PROPERTIES:
:CUSTOM_ID: CostanzoRecipes_Entrees_CurriedLentilDish
:END:
*** Ingredients
...
:PROPERTIES:
:CUSTOM_ID: CostanzoRecipes_Entrees_DriedMushroomSoupWithBarley
:END:
*** Ingredients
...
:PROPERTIES:
:CUSTOM_ID: CostanzoRecipes_Entrees_GeneralTsoSCauliflower
:END:
Prep time 15 mins
Cook time 15 mins
Total time 30 mins
...
:PROPERTIES:
:CUSTOM_ID: CostanzoRecipes_Entrees_GrilledCornAndSweetOnionSalad
:END:
*** Ingredients
...
:PROPERTIES:
:CUSTOM_ID: CostanzoRecipes_Entrees_GrilledVegetableGratin
:END:
*** Ingredients
...
** Mexican Lasagna
:PROPERTIES:
:CUSTOM_ID: CostanzoRecipes_Entrees_MexicanLasagna
:END:
*** Ingredients
...
** Mushroom Pate
:PROPERTIES:
:CUSTOM_ID: CostanzoRecipes_Entrees_MushroomPate
:END:
*** Ingredients
...
** Noodle Kugel
:PROPERTIES:
:CUSTOM_ID: CostanzoRecipes_Entrees_NoodleKugel
:END:
*** Ingredients
- 3 Eggs
- 1 Tbsp of Cinnamon
...
:PROPERTIES:
:CUSTOM_ID: CostanzoRecipes_Entrees_PastaQuillsWithCheesyAubergineEggplantSauce
:END:
Serves 6
*** Ingredients
...
:PROPERTIES:
:CUSTOM_ID: CostanzoRecipes_Entrees_PizzaCrustSourdough
:END:
*** Ingredients
...
:PROPERTIES:
:CUSTOM_ID: CostanzoRecipes_Entrees_PizzaDoughALaNancyNewYorkVariation
:END:
*** Dough
**** Ingredients
- 1 cup warm water
...
:PROPERTIES:
:CUSTOM_ID: CostanzoRecipes_Entrees_PizzaChicagoStyleDeepDish
:END:
*** Dough
**** Ingredients
...
** Quiche
:PROPERTIES:
:CUSTOM_ID: CostanzoRecipes_Entrees_Quiche
:END:
*** Ingredients
- red onion
- red pepper
...
:PROPERTIES:
:CUSTOM_ID: CostanzoRecipes_Entrees_RefriedBeanZucchiniAndCornGratin
:END:
*** Ingredients
**** for the beans
...
:PROPERTIES:
:CUSTOM_ID: CostanzoRecipes_Entrees_RoastedEggplantCrispGarlicAndBasilPasta
:END:
*** Ingredients
...
:PROPERTIES:
:CUSTOM_ID: CostanzoRecipes_Entrees_SmokyGreensAndBeans
:END:
Prep Time: 30 min
Total Time: 30 min
*** Ingredients
...
:PROPERTIES:
:CUSTOM_ID: CostanzoRecipes_Entrees_SouthwesternQuicheWithPotatoCrust
:END:
*** Ingredients
- 6 large eggs
- 1 tsp. salt
...
:PROPERTIES:
:CUSTOM_ID: CostanzoRecipes_Entrees_SpicyBlackBeanCakes
:END:
*** Lime Sour Cream:
**** Ingredients
...
:PROPERTIES:
:CUSTOM_ID: CostanzoRecipes_Entrees_SweetPotatoHashWithMushrooms
:END:
*** Ingredients
...
:PROPERTIES:
:CUSTOM_ID: CostanzoRecipes_Entrees_ThaiRedCurrySummerSquash
:END:
...
:PROPERTIES:
:CUSTOM_ID: CostanzoRecipes_Entrees_UltimateVeggieBurgerRecipe
:END:
...
:PROPERTIES:
:CUSTOM_ID: CostanzoRecipes_Entrees_VegetableEnchiladas
:END:
*** Ingredients
...
** Vegetable Pot Pie
:PROPERTIES:
:CUSTOM_ID: CostanzoRecipes_Entrees_VegetablePotPie
:END:
Prep Time: 1 hr 
...
:PROPERTIES:
:CUSTOM_ID: CostanzoRecipes_Entrees_VegetarianLentilBurgerRecipe
:END:
...
* Sides
:PROPERTIES:
:CUSTOM_ID: CostanzoRecipes_Sides
:END:
...
:PROPERTIES:
:CUSTOM_ID: CostanzoRecipes_Sides_CaramelizedOnionAndSunDriedTomatoDip
:END:
...
:PROPERTIES:
:CUSTOM_ID: CostanzoRecipes_Sides_CauliflowerCroquettes
:END:
*** Ingredients
- 2 baking potatoes
...
5. Sprinkle in the fennel seeds, cumin seeds, chilli, salt and black pepper and mix well.
6. Add the cubes of cheese and gently toss the mixture until evenly combined.
7. Make even sized ‘sausages’ with the croquette mixture, then roll and coat them in plain flour, then the egg and finally coat the panko breadcrumbs. I made about 14 croquettes from this quantity of ingredients.
8. Place the croquettes in the fridge to chill and set for 30–60 minutes. When you are ready to fry them, heat the oil in deep-fryer or large heavy-based saucepan.
9. Deep fry the croquettes for 2–3 minutes or until golden, then transfer onto kitchen paper with a slotted spoon.
...
** Cheese Grits
:PROPERTIES:
:CUSTOM_ID: CostanzoRecipes_Sides_CheeseGrits
:END:
*** Ingredients
- 1/2 c. white grits
- 3/4 tsp. salt
...
:PROPERTIES:
:CUSTOM_ID: CostanzoRecipes_Sides_ChipotleRanchDressing
:END:
...
:PROPERTIES:
:CUSTOM_ID: CostanzoRecipes_Sides_EasyRedPepperHummus
:END:
Serves 8
*** Ingredients
...
** Habanero Hot Sauce
:PROPERTIES:
:CUSTOM_ID: CostanzoRecipes_Sides_HabaneroHotSauce
:END:
*** Ingredients
...
** Hollandaise Sauce
:PROPERTIES:
:CUSTOM_ID: CostanzoRecipes_Sides_HollandaiseSauce
:END:
*** Ingredients
- 2 egg yolks
- 3 Tbls lemon juice
...
:PROPERTIES:
:CUSTOM_ID: CostanzoRecipes_Sides_IndianStyleRiceSalad
:END:
...
:PROPERTIES:
:CUSTOM_ID: CostanzoRecipes_Sides_JapaneseGingerDressing
:END:
*** Ingredients
+ 1/2 onion
+ 1/2 cup canola oil
...
:PROPERTIES:
:CUSTOM_ID: CostanzoRecipes_Sides_LentilAndBlackBeanSoupWithSmokedPaprika
:END:
*** Ingredients
- 1 tablespoon olive oil
- 1/2 large onion chopped
...
:PROPERTIES:
:CUSTOM_ID: CostanzoRecipes_Sides_OvenRoastedBrusselsSproutsWithBalsamicVinegar
:END:
*** Ingredients
...
** Patatas Bravas
:PROPERTIES:
:CUSTOM_ID: CostanzoRecipes_Sides_PatatasBravas
:END:
*** Ingredients
**** Dipping Sauce:
...
** Persian Carrots
:PROPERTIES:
:CUSTOM_ID: CostanzoRecipes_Sides_PersianCarrots
:END:
*** First Recipe
**** Ingredients
...
:PROPERTIES:
:CUSTOM_ID: CostanzoRecipes_Sides_StracciatellaItalianEggDropSoup
:END:
*** Ingredients
- 4 Eggs
...
:PROPERTIES:
:CUSTOM_ID: CostanzoRecipes_Sides_SyrupyAgedBalsamicInMinutes
:END:
*** Ingredients
Combine:
- 1/3 cup balsamic
...
:PROPERTIES:
:CUSTOM_ID: CostanzoRecipes_Sides_TakeoutStyleBroccoliWithGarlicSauce
:END:
*** Yield
Serves: 4
*** Ingredients
...
:PROPERTIES:
:CUSTOM_ID: CostanzoRecipes_Sides_WhiteCornTortillaSoup
:END:
*** Ingredients
**** For 5 servings:
